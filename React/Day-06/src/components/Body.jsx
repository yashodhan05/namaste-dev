...
const Body = () => {
  ...
  const fetchData = async () => {
    const data = await fetch(
      "https://corsproxy.io/?url=https://www.swiggy.com/dapi/restaurants/list/v5?lat=18.5165691&lng=73.8036752&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING",
    );
